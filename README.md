...
C*                                                                        *
               *
C*             Sara Sayyadi, Magnus T. Gudmundsson  2020                    *
C**************************************************************************
C*
...
C
C
C*  Ny ⁄tg·fa fyrir Lahey fortran 90.  Les inn ASCII £tg†fu af surfer
C*  grid skr†.
C*  Innskr† 1:   ASCII grid-skr†
C*  Innskr† 2:   Skr† meå Lambertshnitum og free-air gildum fr† forritinu
C*               FREEAIR eåa TTCLAM.
C*  ßtskr†:      Skr† † sama formi og fr† FREEAIR en forritiå hefur
C*               skrifaå inn ° einn af TTC d†lkunum.
C*
C*  çessi £tg†fa vinnur † tveimur griddum, annarsvegar 200x200 m,
C*  hins vegar 1000x1000 m.
C*
C*  Forritiå notar eålismassa 900 kg/m3 bëåi fyrir °s og berg.
C*
C*  • £tskr†nni eru fj¢rir d†lkar fyrir landslags+Bouguer leiår.
C*  (d†lkar 5-8):
C*   D†lkar 5 og 7 eru fyrir °s (efra yfirborå).
C*   D†lkar 6 og 8 eru fyrir berg (neåra yfirborå).
C*   D†lkar 5 og 6 eru fyrir leiår. fr† 0 til 6 km (200x200 m grid).
C*   D†lkar 7 og 8  "    "     "    fr† 6 til 50 km (1000x1000 m grid).
C*
C*  ATH:  forritiå vinnur † "rÇttum" Lambertshnitum.  Ekki hnitum meå
C*        X-hnit m°nustîlu.  Skr†rnar eru ï¢ meå -X til samrëmis viå
C*        grid af jîklum og landi † jaråeålisfrëåistofu RH.
C*
C*                              7.7. 1997 MTG
C*
C*      !!! Breyting gerå 20.1 1998:  Stîåvarnafn sett fremst ° l°nu °
C*      ïyngdargagnaskr†.  Allstaåar ïar sem l°nun£mer 3000 (formatsetning
...
C**************************************************************************
     ...
     +,x1,x2,y1,y2,z,tc,FA
      ...
      G=6.673E-11
       PHI=3.141592654D0
c
       write (*,*) 'ATH: ïessi £tg†fa leiårÇttir £t ° 50 km '
C    Density (kg/m3)
...
C çessi innlestur er fyrir skr† £r GRID
C
